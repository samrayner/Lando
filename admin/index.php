...
<form action="save.php" method="post" id="admin-form">
	...
	<section id="content">
		...
		<div>
			...
			<p id="cron-job" data-icon="!" class="notify <?php if(isset($config["cache_on_load"]) && !$config["cache_on_load"]) echo " collapsed" ?>">For better performance, consider <a href="#">setting up a cron job</a> and disabling this.</p>
		</div>
